...
Analyzes the squad depth of your Football Manager 2024 team, selects the best and second-best starting XIs for a 4-2-3-1 formation, and generates a depth chart with reinforcement suggestions.
...
Reads `C:\Users\xyy\Documents\Sports Interactive\Football Manager 2024\team.rtf` by default and writes the result to `fm_analysis.html`.
...
```
fm_analysis.py       Core logic: RTF parsing, EA calculation, lineup selection, HTML generation
